    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='sem descrição', verbose_name='Descrição')),
                ('contracting_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.company', verbose_name='Empresa Contratante')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.company', verbose_name='Empresa Contratante'),
        ),
