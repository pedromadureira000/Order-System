...
class ItemTable(models.Model):
    ...
    item_table_compound_id = models.CharField('Id da tabela de itens', max_length=7, unique=True, editable=False)
...
class Item(models.Model):
    ...
    item_compound_id = models.CharField('Item compound id', max_length=23, unique=True, editable=False)
    ...
    barcode = models.CharField(max_length=13, verbose_name="Barcode", blank=True)
...
class ItemCategory(models.Model):
    ...
    category_compound_id = models.CharField('Item category compound id', max_length=16, unique=True, editable=False)
...
class PriceItem(models.Model):
    ...
    price_table = models.ForeignKey('PriceTable', on_delete=models.CASCADE, related_name='price_items', verbose_name="Price table")
...
class Order(models.Model):
    ...
    invoice_number = models.CharField(max_length=9, blank=True)
