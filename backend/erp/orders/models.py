...
class Order(models.Model):
    ...
    company = models.ForeignKey('user.Company', on_delete=models.CASCADE, verbose_name="Empresa")
    user = models.ForeignKey('user.User', on_delete=models.PROTECT, verbose_name="Usuário")
