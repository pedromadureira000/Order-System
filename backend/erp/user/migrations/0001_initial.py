    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_table', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='orders.pricetable', verbose_name='Tabela preço')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='user.company', verbose_name='Empresa')),
