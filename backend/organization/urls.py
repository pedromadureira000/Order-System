...
from .views import (
    ClientTableView, ClientView, ContractingView, EstablishmentView, GetClientTablesToCreateClient, GetCompaniesToCreateEstablishment, GetEstablishmentsToCreateClient, GetPriceTablesToCreateClient, SpecificClient, SpecificClientTable, SpecificContracting, SpecificEstablishment, CompanyView, SpecificCompany
)
