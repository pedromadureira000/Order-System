    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_code', models.IntegerField(unique=True, verbose_name='Código da empresa')),
                ('status', models.CharField(choices=[('A', 'Ativado'), ('D', 'Desativado'), ('B', 'Bloqueado')], max_length=1)),
                ('company_type', models.CharField(choices=[('D', 'Distribuidora'), ('L', 'Lojista'), ('O', 'Outros')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='LoggedInUser',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='logged_in_user', to='core.user')),
            ],
        ),
        migrations.AddField(
            model_name='user',
