  ...
  export default {
    ...
    data(){ 
      return {
        value: '',
        allMenuItems: [
          {permissions: CRUDerpUserPermissions, title: "ERP_User", icon: "mdi-account-tie", to: "admin-user-erp_user"},
          {permissions: CRUDadminAgentPermissions, title: "Admin_Agent", icon: "mdi-account-tie", to: "admin-user-admin_agent"},
          {permissions: CRUDagentPermissions, title: "Agent", icon: "mdi-account-cog", to: "admin-user-agent"},
